...
const AddProduct = () => {
  ...
  const [file, setFile] = useState<string>(''); // getting uploaded image file separately
  ...
  const handleSubmit = (e: any) => {
    ...
    newFormData.append('name', formData.name); // check MDN about this append
